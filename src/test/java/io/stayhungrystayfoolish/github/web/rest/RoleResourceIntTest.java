...
import io.stayhungrystayfoolish.github.RoleTestApp;
...
import io.stayhungrystayfoolish.github.web.rest.errors.ExceptionTranslator;
...
import static io.stayhungrystayfoolish.github.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = RoleTestApp.class)
public class RoleResourceIntTest {
    ...
    /**
     * This repository is mocked in the io.stayhungrystayfoolish.github.repository.search test package.
     *
     * @see io.stayhungrystayfoolish.github.repository.search.RoleSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createRole() throws Exception {
        ...
        assertThat(testRole.getAuthorityName()).isEqualTo(DEFAULT_AUTHORITY_NAME);
    ...
    public void updateRole() throws Exception {
        ...
        assertThat(testRole.getAuthorityName()).isEqualTo(UPDATED_AUTHORITY_NAME);
