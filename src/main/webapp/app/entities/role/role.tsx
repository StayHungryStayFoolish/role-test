...
export interface IRoleState extends IPaginationBaseState {
  search: string;
}
...
export class Role extends React.Component<IRoleProps, IRoleState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="role-heading">
          <Translate contentKey="roleTestApp.role.home.title">Roles</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="roleTestApp.role.home.createLabel">Create new Role</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('roleTestApp.role.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('roleName')}>
                  <Translate contentKey="roleTestApp.role.roleName">Role Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('authorityName')}>
                  <Translate contentKey="roleTestApp.role.authorityName">Authority Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
