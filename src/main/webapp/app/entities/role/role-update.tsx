    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="roleTestApp.role.home.createOrEditLabel">
              <Translate contentKey="roleTestApp.role.home.createOrEditLabel">Create or edit a Role</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : roleEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="roleNameLabel" for="roleName">
                    <Translate contentKey="roleTestApp.role.roleName">Role Name</Translate>
                  </Label>
                  <AvField
                    id="role-roleName"
                    type="text"
                ...
                <AvGroup>
                  <Label id="authorityNameLabel" for="authorityName">
                    <Translate contentKey="roleTestApp.role.authorityName">Authority Name</Translate>
                  </Label>
                  <AvField
                    id="role-authorityName"
                    type="text"
                    name="authorityName"
                    validate={{
                      required: { value: true, errorMessage: translate('entity.validation.required') },
